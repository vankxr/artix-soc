...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_axi_7seg_0_0 -prefix
--               design_1_axi_7seg_0_0_ design_1_axi_7seg_0_0_sim_netlist.vhdl
...
entity design_1_axi_7seg_0_0_axi_7seg_v1_0_AXI is
  port (
    ...
    \cnt_reg[21]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \cnt_reg[30]\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
    ...
    cnt_reg : in STD_LOGIC_VECTOR ( 31 downto 0 );
...
end design_1_axi_7seg_0_0_axi_7seg_v1_0_AXI;

architecture STRUCTURE of design_1_axi_7seg_0_0_axi_7seg_v1_0_AXI is
  signal \^sr\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \an[1]_i_10_n_0\ : STD_LOGIC;
  signal \an[1]_i_5_n_0\ : STD_LOGIC;
  signal \an[1]_i_6_n_0\ : STD_LOGIC;
  signal \an[1]_i_7_n_0\ : STD_LOGIC;
  signal \an[1]_i_8_n_0\ : STD_LOGIC;
  signal \an[1]_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \an[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \an[0]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \an[1]_i_6\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \an[1]_i_8\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \sseg[0]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \sseg[1]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \sseg[2]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \sseg[3]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \sseg[4]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \sseg[5]_INST_0\ : label is "soft_lutpair2";
begin
  SR(0) <= \^sr\(0);
...
\an[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\an[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\an[1]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\an[1]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\an[1]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\an[1]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\an[1]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\an[1]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\an[1]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\an[1]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\sseg[0]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4814FFFF"
    )
        port map (
...
\sseg[1]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"D860FFFF"
    )
        port map (
...
\sseg[2]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"8A04FFFF"
    )
        port map (
...
\sseg[3]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"8294FFFF"
    )
        port map (
...
\sseg[4]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02AEFFFF"
    )
        port map (
...
\sseg[5]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"408EFFFF"
    )
        port map (
...
\sseg[6]_INST_0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0491FFFF"
    )
        port map (
...
\sseg[6]_INST_0_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\sseg[6]_INST_0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0FFAACCF000AACC"
    )
        port map (
...
\sseg[6]_INST_0_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0FFAACCF000AACC"
    )
        port map (
...
\sseg[6]_INST_0_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0FFAACCF000AACC"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_axi_7seg_0_0_axi_7seg_v1_0 is
  port (
    sseg : out STD_LOGIC_VECTOR ( 6 downto 0 );
...
end design_1_axi_7seg_0_0_axi_7seg_v1_0;

architecture STRUCTURE of design_1_axi_7seg_0_0_axi_7seg_v1_0 is
  signal an : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \an[0]_i_1_n_0\ : STD_LOGIC;
  signal \an[1]_i_1_n_0\ : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_1 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_13 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_14 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_15 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_16 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_17 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_18 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_19 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_20 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_21 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_22 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_23 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_24 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_25 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_26 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_27 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_28 : STD_LOGIC;
  signal axi_7seg_v1_0_AXI_inst_n_29 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \sseg_an[0]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sseg_an[1]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \sseg_an[2]_INST_0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \sseg_an[3]_INST_0\ : label is "soft_lutpair8";
begin
...
axi_7seg_v1_0_AXI_inst: entity work.design_1_axi_7seg_0_0_axi_7seg_v1_0_AXI
     port map (
      CO(0) => \cnt0_carry__1_n_1\,
      S(3) => axi_7seg_v1_0_AXI_inst_n_13,
      S(2) => axi_7seg_v1_0_AXI_inst_n_14,
      S(1) => axi_7seg_v1_0_AXI_inst_n_15,
      S(0) => axi_7seg_v1_0_AXI_inst_n_16,
      SR(0) => axi_7seg_v1_0_AXI_inst_n_1,
      ...
      cnt_reg(31 downto 0) => cnt_reg(31 downto 0),
      \cnt_reg[21]\(3) => axi_7seg_v1_0_AXI_inst_n_17,
      \cnt_reg[21]\(2) => axi_7seg_v1_0_AXI_inst_n_18,
      \cnt_reg[21]\(1) => axi_7seg_v1_0_AXI_inst_n_19,
      \cnt_reg[21]\(0) => axi_7seg_v1_0_AXI_inst_n_20,
      \cnt_reg[30]\(2) => axi_7seg_v1_0_AXI_inst_n_21,
      \cnt_reg[30]\(1) => axi_7seg_v1_0_AXI_inst_n_22,
      \cnt_reg[30]\(0) => axi_7seg_v1_0_AXI_inst_n_23,
...
\cnt0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => axi_7seg_v1_0_AXI_inst_n_17,
      S(2) => axi_7seg_v1_0_AXI_inst_n_18,
      S(1) => axi_7seg_v1_0_AXI_inst_n_19,
      S(0) => axi_7seg_v1_0_AXI_inst_n_20
    );
\cnt0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => axi_7seg_v1_0_AXI_inst_n_21,
      S(1) => axi_7seg_v1_0_AXI_inst_n_22,
      S(0) => axi_7seg_v1_0_AXI_inst_n_23
    );
...
entity design_1_axi_7seg_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of design_1_axi_7seg_0_0 : entity is "design_1_axi_7seg_0_0,axi_7seg_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_axi_7seg_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_axi_7seg_0_0 : entity is "axi_7seg_v1_0,Vivado 2021.1";
...
architecture STRUCTURE of design_1_axi_7seg_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of axi_aclk : signal is "XIL_INTERFACENAME AXI_ACLK, ASSOCIATED_RESET axi_aresetn, ASSOCIATED_BUSIF AXI, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
...
inst: entity work.design_1_axi_7seg_0_0_axi_7seg_v1_0
     port map (
      axi_aclk => axi_aclk,
